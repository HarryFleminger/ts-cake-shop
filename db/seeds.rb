...
cheese_cake = Product.create(name: "Cheese Cake", sku: "cheesecake", price_cents: 15000, description: "Cheesy goodnes")
sponge_cake = Product.create(name: "Sponge Cake", sku: "spongebob", price_cents: 10000, description: "Spongey")
victoria_cake = Product.create(name: "Victoria Cream Cake", sku: "victorianus", price_cents: 5000, description: "Creamy victorianus")
